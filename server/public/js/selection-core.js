/**
 * Core selection state and interaction logic for multi-select.
 * Handles Ctrl+click, Shift+click, marquee drag-select, and keyboard shortcuts.
 * Mixed into the main Alpine component via the selection.js aggregator.
 */
function dmxrSelectionCore() {
  return {
    // Selection state
    selectedFixtureIds: [],
